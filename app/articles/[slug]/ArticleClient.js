...
const sidebarLinks = [
  ...
  { slug: "campus-placement-rounds", title: "Campus Placement Rounds", tag: "Placement Prep", color: "#4ECDC4" },
  { slug: "commit-messages", title: "Writing Commit Messages", tag: "Industry Reality", color: "#60A5FA" },
  { slug: "first-open-source-pr", title: "Your First Open Source PR", tag: "Open Source", color: "#F472B6" },
];
      ...
      elements.push(
        <div key={i} style={{ background: "#1A1A2E", borderRadius: 10, overflow: "hidden", border: "1px solid #2A2A3E", margin: "16px 0" }}>
          ...
          <pre style={{ padding: 20, margin: 0, overflowX: "auto" }}>
            <code style={{ fontFamily: "'Fira Code', monospace", fontSize: 13, color: "#E8E8F0", lineHeight: 1.7 }}>
              {codeLines.join('\n')}
            </code>
          </pre>
        </div>
        ...
        <main style={{ flex: 1, paddingTop: 40, paddingBottom: 80, minWidth: 0 }}>
          ...
          {article && (
            <div>
              ...
              <div style={{ marginTop: 60, paddingTop: 32, borderTop: "1px solid #E8E4DC" }}>
